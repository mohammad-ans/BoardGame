...
## Features
- The game supports both landscape and portrait modes without losing information when activity is destroyed while rotating. It is recommended to use landscape mode on tablets as some mobile's width may be very small making the experience unpleasant.
